...
{if {$oasl_widget_location} eq 'left'}
	<div class="block oneall_social_login_block" id="oneall_social_login_block_left">
		{if {$oasl_widget_title} neq ''}
			<h4>{$oasl_widget_title}</h4>
		{/if}
		<p class="block_content">
			<span class="oneall_social_login_providers" id="oneall_social_login_providers_{$oasl_widget_rnd}" style="padding:15px 15px 0 15px;display:block"></span>
			<script type="text/javascript">
