...
class oneall_social_login_providers
{
    ...
    public static function get_list()
    {
        $providers = array(
            ...
            'battlenet' => array('name' => 'Battle.net'),
            'blogger' => array('name' => 'Blogger'),
            'discord' => array('name' => 'Discord'),
            'disqus' => array('name' => 'Disqus'),
            'dribbble' => array('name' => 'Dribbble'),
            'draugiem' => array('name' => 'Draugiem'),
            'facebook' => array('name' => 'Facebook'),
            'foursquare' => array('name' => 'Foursquare'),
            'github' => array('name' => 'Github.com'),
            'google' => array('name' => 'Google'),
            'instagram' => array('name' => 'Instagram'),
            'line' => array('name' => 'Line'),
            'linkedin' => array('name' => 'LinkedIn'),
            'livejournal' => array('name' => 'LiveJournal'),
            'mailru' => array('name' => 'Mail.ru'),
            'meetup' => array('name' => 'Meetup'),
            'odnoklassniki' => array('name' => 'Odnoklassniki'),
            'openid' => array('name' => 'OpenID'),
            'paypal' => array('name' => 'PayPal'),
            'pinterest' => array('name' => 'Pinterest'),
            'pixelpin' => array('name' => 'PixelPin'),
            'reddit' => array('name' => 'Reddit'),
            'skyrock' => array('name' => 'Skyrock.com'),
            'soundcloud' => array('name' => 'SoundCloud'),
            'stackexchange' => array('name' => 'StackExchange'),
            'steam' => array('name' => 'Steam'),
            'twitch' => array('name' => 'Twitch.tv'),
            'twitter' => array('name' => 'Twitter'),
            'tumblr' => array('name' => 'Tumblr'),
            'vimeo' => array('name' => 'Vimeo'),
            'vkontakte' => array('name' => 'VKontakte'),
            'weibo' => array('name' => 'Weibo'),
            'windowslive' => array('name' => 'Windows Live'),
            'wordpress' => array('name' => 'WordPress.com'),
